...
struct TopicView: View {
    ...
    let navItems = [
        ...
        NavItem( name: "Identifying Trades 🔎" , menu : .intermediate),
        NavItem(name: "Using Alvatix to ace the game 🧠" , menu : .advance )
...
//            }
            ...
            NavigationStack{
                ...
                List(navItems , id : \.self) { item in NavigationLink(item.name , value:item).padding(70).font(.largeTitle).bold()        .navigationDestination(for: NavItem.self, destination: {
